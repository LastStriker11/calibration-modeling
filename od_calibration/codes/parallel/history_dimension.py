# -*- coding: utf-8 -*-
"""
Created on Fri Jan 15 09:33:51 2021
...
def draw_method(rmsn, lenMark, method):
    ...
    fig.savefig('spatial_temporal/figures/history_dimension_method'+str(method)+'.pdf')
#=============================  
days = [10, 100, 200]
method = 6
rmsn = pd.DataFrame()
...
for day in days:
    suffix = str(day)
    lenMark.append('$n_d$: '+str(day))
    rmsn0 = pd.read_pickle('spatial_temporal/history_dimension/counts_rmsn'+suffix+'_'+str(method)+'.pckl')[0]
